...
export default {
    ...
    methods: {
        ...
        openBrowser() {
            ...
            const target = "_blank";
            const options = `location=no,hardwareback=no,footer=yes,closebuttoncaption="CLOSE",closebuttoncolor=${process.env.primaryColor},footercolor=${process.env.primaryColor}`;
