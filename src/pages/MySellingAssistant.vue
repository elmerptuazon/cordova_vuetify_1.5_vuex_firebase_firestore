<template>
  <div>
    ...
    <v-container>
      ...
      <v-layout row wrap>
        <v-flex xs12>
          <img :src="paymentImage" alt="payment" class="responsive" @click="goTo('Payments')">
        </v-flex>
        <v-flex xs12>
          <img :src="calendarImage" alt="calendar" class="responsive" @click="goTo('Calendar')">
        </v-flex>
        <!-- <v-flex xs12>
        ...
        <v-flex xs12>
          <img :src="salesImage" alt="salesp" class="responsive" @click="goTo('SalesPerformance')">
        </v-flex>
        <v-flex xs12>
